...
using Fbs_webApi_v1.Repositorys;

namespace Fbs_webApi_v1.Controllers
{
    ...
    public class UsersController : ControllerBase
    {
        ...
        public UsersController(FbsContext context)
        {
            _context = context;
        }
        ...
        public async Task<ActionResult<User>> PostUser(User user)
        {
          if (_context.users == null)
          {
              return Problem("Entity set 'FbsContext.users'  is null.");
          }
